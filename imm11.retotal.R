...
ivwFile = "immune-disease.IVWfilter.csv"  # IVW方法过滤的结果文件

# 设置工作目录
setwd("E:\\K_课题设计\\MR课题\\免疫\\弥漫大B细胞淋巴瘤diffuse large B-cell lymphoma\\10.retotal")  
...
exposure_dat <- subset(exposureData, pval.exposure < 5e-06)
